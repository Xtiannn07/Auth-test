...
export default function ProfileSidebar({ currentUser, userData, isGuest }) {
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-md shadow p-4">
        ...
        {isGuest ? (
          <p className="text-gray-500 text-sm text-center">Sign in to see your photos</p>
      ...
      <div className="bg-white rounded-md shadow p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          {!isGuest && userData?.friends && userData.friends.length > 0 && (
            <a href="#" className="text-blue-500 text-sm">See All</a>
          )}
        </div>
        {isGuest ? (
          <p className="text-gray-500 text-sm text-center">Sign in to see your friends</p>
